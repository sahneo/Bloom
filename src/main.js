...
async function init() {
  ...
  const VJ_PRESET_POOL = ['particles', 'silk', 'flora', 'fluid', 'void', 'cymatics', 'storm', 'terra', 'swarm', 'galaxy', 'glass', 'acid', 'prism', 'type', 'physarum', 'aurora', 'pyro', 'fireflies', 'medusa', 'frost'];   // fx needs media — manual only
