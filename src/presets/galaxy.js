...
export class GalaxyPreset {
  ...
  async init(device, format, canvas) {
    this.device = device;
    this.canvas = canvas;
    const module = device.createShaderModule({ label: 'galaxy', code: shaderSource });
